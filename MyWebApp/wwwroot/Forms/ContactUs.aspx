<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ContactUs.aspx.cs" Inherits="Forms_ContactUs" %>
...
<body>
  ...
  <table width="800" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
    <tr>
      <td height="74" colspan="3" valign="top" background="../images/Header-bg.jpg"><table width="800" height="74" border="0" cellpadding="0" cellspacing="0">
          <tr>
    ...
    <tr>
      <td colspan="3" valign="top" bgcolor="#FFFFFF"><center><table width="500" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td colspan="3" class="footertxt"></td>
          </tr>
        <tr>
          <td width="236" height="8"></td>
          <td width="14" rowspan="2" valign="top">&nbsp;</td>
          <td width="250" rowspan="2" valign="top"><img src="../images/contactus-pic.jpg" width="250" height="181"></td>
        </tr>
        <tr>
          <td class="Contactustxt">
          <span class="footertxt">Contact Us</span>
          <br/>
          <br/>
          198 Oxford Road
          <br/>
...
RG30 1AA
    ...
    <tr>
      ...
      <td width="768" valign="top" bgcolor="#FFFFFF">&nbsp;</td>
    ...
    <tr>
      <td colspan="3" valign="top" bgcolor="#fe272a" height="30"><center>
